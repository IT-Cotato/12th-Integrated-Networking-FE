...
export default function Sidebar({
  ...
  return (
    <aside className="w-[248px] min-h-screen bg-white rounded-tr-[48px] rounded-br-[48px] pt-12 pr-4 pb-12 pl-4 flex flex-col gap-10 shadow-lg">
      {/* 위치 목록 타이틀 */}
      <div className="flex items-center gap-2 px-4">
        <img src="/map-pin-front-color.svg" alt="위치 목록" className="w-5 h-5" />
      ...
      >
        <img src="/plus-front-clay.svg" alt="추가" className="w-[40px] h-[40px]" />
                ...
                <div className="flex-shrink-0 w-6 h-6 flex items-center justify-center">
                  <AnimatePresence mode="wait">
                    {hoveredLocation === location.id ? (
                      ...
                      >
                        <img src="/trash-can-front-color.svg" alt="삭제" className="width 24px height 24px" />
                      </motion.div>
                    ) : selectedLocation === location.id ? (
                      <motion.div
                        key="pin"
                      ...
                      >
                        <img src="/map-pin-front-color.svg" alt="선택됨" className="w-4 h-4" />
                      </motion.div>
                    ) : null}
                  </AnimatePresence>
                </div>
