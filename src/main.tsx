    ...
    const handleKakaoCallback = async () => {
      ...
      try {
        ...
        try {
          ...
          alert('브라우저 저장소에 저장할 수 없습니다. 시크릿 모드를 사용 중이신가요?');
          navigate('/');
          return;
        }
        ...
        console.log('📦 저장 확인');
        console.log('====================================');
        console.log('accessToken:', savedAccessToken ? `${savedAccessToken.substring(0, 30)}...` : '❌ 없음');
        console.log('refreshToken:', savedRefreshToken ? `${savedRefreshToken.substring(0, 30)}...` : '❌ 없음');
